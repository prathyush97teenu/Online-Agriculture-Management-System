    ...
    <body background="images/coverpic.jpg">
        <%
            ...
            try{
                ...
                st.executeUpdate("update fertilizers set fertilizername='calcium nitrate',fertilizertype='inorganic',nitrogen='15.5',phosphorus='7.3',fertilizercost='500.0' where fertilizerid="+fertilizerid);
        ...
        <h3>Fertilizer is Successfully Updated</h3>  
    </body>
</html>
<%}}
else{
