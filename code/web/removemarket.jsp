...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Remove Market Information</h3></header>
            <form action="submitremovemarket.jsp">
            <div class="container">
            <label><b>Market Id</b></label><br>
            <input type="number" placeholder="Remove Market" name="marketid"><br><br>
