    ...
    <body background="images/coverpic.jpg">
        <%
            ...
            try{
                ...
                st.executeUpdate("insert into cropdetails(cropid,cropname,soilid,season,croptype)values('"+ cropid+"','"+cropname +"','"+soilid+"','"+ season+"','"+ croptype+"')");
        ...
        <h3>Crop is Successfully Added</h3>  
    </body>
</html>
<%}}
else{
