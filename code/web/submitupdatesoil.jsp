    ...
    <body background="images/coverpic.jpg">
        <%
            ...
            try{
                ...
                st.executeUpdate("update soils set soiltype='sandy soil',soilcode='SS',statecode='KL',districtcode='688001',districtname='alleppey' where soilid="+soilid);
        ...
        <h3>Soil is Successfully Updated</h3>  
    </body>
</html>
<%}}
else{
