...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Add Crop Information</h3></header>
            <form action="submitaddcrop.jsp">
            <div class="container">
            <label><b>Crop Id<br></b></label>
            <input type="number" name="cropid">
            <label><b><br>Crop Name</b></label>
            <input type="text" name="cropname">
            <label><b><br>Soil Id<br></b></label>
            <input type="number" name="soilid">
            <label><b><br>Season</b></label>
