...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Add Fertilizer Information</h3></header>
            <form action="submitaddfertilizer.jsp">
            <div class="container">
            <label><b>Fertilizer Id<br></b></label>
            <input type="number" name="fertilizerid">
            <label><b><br>Fertilizer Name</b></label>
            <input type="text" name="fertilizername">
            <label><b>Fertilizer Type</b></label>
            <input type="text" name="fertilizertype">
            <label><b>Soil Id</b></label>
            <input type="text" name="soilid">
            <label><b>Crop Id</b></label>
            <input type="text" name="cropid">
            <label><b>Nitrogen</b></label>
            <input type="text" name="nitrogen">
            <label><b>Phosphorus</b></label>
            <input type="text" name="phosphorus">
            <label><b>Fertilizer Cost</b></label>
            <input type="text" name="fertilizercost">
