    ...
    <body background="images/coverpic.jpg">
        <%
            ...
            try{
                ...
                st.executeUpdate("update commodity set commodityname='cotton',grades='A',price='68.65',volume='1970' where commodityid="+commodityid);
        ...
        <h3>Commodity is Successfully Updated</h3>  
    </body>
</html>
<%}}
else{
