...
<html>
    ...
    <body background="images/coverpic.jpg">
        <%
            ...
            String fertilizercost = request.getParameter("fertilizercost");
            ...
            try{
                ...
                st.executeUpdate("insert into fertilizers(fertilizerid,fertilizername,fertilizertype,soilid,cropid,nitrogen,phosphorus,fertilizercost)values('"+fertilizerid +"','"+fertilizername +"','"+ fertilizertype+"','"+soilid +"','"+ cropid+"','"+nitrogen+"','"+phosphorus +"','"+ fertilizercost+"')");
        ...
        <h3>Fertilizer is Successfully Added</h3>  
    </body>
</html>
<%}}
else{
