...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Add Soil Information</h3></header>
            <form action="submitaddsoil.jsp">
            <div class="container">
            <label><b>Soil Id</b></label><br>
            <input type="number" name="soilid"><br>
            <label><b>Soil Type</b></label><br>
            <input type="text"  name="soiltype"><br>
            <label><b>Soil Code</b></label><br>
            <input type="text"  name="soilcode"><br>
            <label><b>State Code</b></label><br>
            <input type="text"  name="statecode"><br>
            <label><b>District Code</b></label><br>
            <input type="text"  name="districtcode"><br>
            <label><b>District Name</b></label><br>
            <input type="text"  name="districtname"><br><br>
