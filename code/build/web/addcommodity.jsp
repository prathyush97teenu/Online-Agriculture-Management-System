...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Add Commodity Information</h3></header>
            <form action="submitaddcommodity.jsp">
            <div class="container">
            <label><b>Commodity Id<br></b></label>
            <input type="number" name="commodityid">
            <label><b><br>Commodity Name</b></label>
            <input type="text" name="commodityname">
            <label><b><br>Grade<br></b></label>
            <input type="text" name="grades">
            <label><b><br>Price</b></label>
            <input type="text" name="price">
            <label><b>Volume</b></label>
            <input type="text" name="volume">
            <label><b>Market Id</b></label>
