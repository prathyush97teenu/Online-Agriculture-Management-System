...
<html>
    ...
    <body background="images/coverpic.jpg">
        ...
        <div class="divtable">
            <header><h3>Update Commodity</h3></header>
            <form action="submitupdatecommodity.jsp">
            <div class="container">
                <label><b>Commodity Id</b></label><br>
                <input type="number" placeholder="Enter Commodity Id" name="commodityid"><br><br>
